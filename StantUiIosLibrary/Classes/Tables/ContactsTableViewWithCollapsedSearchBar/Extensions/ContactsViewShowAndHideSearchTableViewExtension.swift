//
//  ContactsViewShowAndHideSearchTableViewExtension.swift
//  Pods-StantUiIosLibraryDemo
//
//  Created by Renato Vieira on 02/12/19.
//

import UIKit

extension ContactsTableViewWithCollapseSearchBar: ContactsAndHideSearchTableViewDelegate {
